...
export const GHANA_DISTRICTS: GhanaDistrict[] = [
  ...
  { code: "AS-BS", name: "Bekwai (Old)", regionCode: "AS", type: "district" },
  { code: "AS-EJ", name: "Ejisu-Juaben Municipal", regionCode: "AS", type: "municipal" },
  { code: "AS-EJ1", name: "Ejura Sekyedumasi", regionCode: "AS", type: "district" },
