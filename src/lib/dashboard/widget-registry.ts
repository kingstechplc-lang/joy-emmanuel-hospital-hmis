...
export const DEFAULT_LAYOUT: WidgetPlacement[] = [
  // KPI row — 5 small widgets
  { widgetId: "kpi_total_patients", x: 0, y: 0, w: 2, h: 1, config: {} },
  { widgetId: "kpi_today_encounters", x: 2, y: 0, w: 2, h: 1, config: {} },
  { widgetId: "kpi_today_appointments", x: 4, y: 0, w: 2, h: 1, config: {} },
  { widgetId: "kpi_active_admissions", x: 6, y: 0, w: 2, h: 1, config: {} },
  { widgetId: "kpi_pending_lab_orders", x: 8, y: 0, w: 2, h: 1, config: {} },
  { widgetId: "kpi_pending_prescriptions", x: 10, y: 0, w: 2, h: 1, config: {} },
  // Second KPI row
  { widgetId: "kpi_today_revenue", x: 0, y: 1, w: 2, h: 1, config: {} },
  { widgetId: "kpi_outstanding_invoices", x: 2, y: 1, w: 2, h: 1, config: {} },
  { widgetId: "kpi_low_stock", x: 4, y: 1, w: 2, h: 1, config: {} },
  { widgetId: "kpi_pending_tasks", x: 6, y: 1, w: 2, h: 1, config: {} },
  { widgetId: "kpi_bed_occupancy", x: 8, y: 1, w: 2, h: 1, config: {} },
  { widgetId: "kpi_today_discharges", x: 10, y: 1, w: 2, h: 1, config: {} },
  // Quick actions panel (full width)
  { widgetId: "panel_quick_actions", x: 0, y: 2, w: 12, h: 2, config: {} },
  // Two-column row: recent patients (8) + ward occupancy (4)
  { widgetId: "list_recent_patients", x: 0, y: 4, w: 8, h: 3, config: {} },
  { widgetId: "list_ward_occupancy", x: 8, y: 4, w: 4, h: 3, config: {} },
  // My pending tasks (full width)
  { widgetId: "list_pending_tasks", x: 0, y: 7, w: 12, h: 2, config: {} },
];
