    ...
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] flex flex-col p-0 gap-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 grid grid-cols-3 gap-3 text-xs bg-slate-50 p-3 rounded-lg">
          <div><Label className="flex-1 overflow-y-auto p-6 text-slate-500">Blood Group</Label><div className="font-bold text-rose-600 text-lg">{donor.bloodGroup || "—"}</div></div>
