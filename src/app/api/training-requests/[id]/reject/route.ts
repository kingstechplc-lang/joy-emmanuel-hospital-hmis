// API: /api/training-requests/[id]/reject — POST
...
export async function POST(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  await auditLog({ userId: session.user.id, organizationId: session.user.organizationId, action: "TRAINING_REQUEST_REJECTED", resourceType: "training_request", resourceId: id, reason: body.comment || body.reason });
