...
export async function GET(req: Request) {
  ...
  if (search) {
    where.OR = [
      { transfusionNumber: { contains: search, mode: "insensitive" } },
    ];
  }
...
export async function POST(req: Request) {
  ...
  if (body.patientName === undefined || body.patientName === "" || body.patientName === null || body.unitId === undefined || body.unitId === "" || body.unitId === null) {
