...
export async function POST(req: Request) {
  ...
  if (body.patientName === undefined || body.patientName === "" || body.patientName === null || body.procedureName === undefined || body.procedureName === "" || body.procedureName === null || body.scheduledStart === undefined || body.scheduledStart === "" || body.scheduledStart === null) {
