// =====================================================================
// API: /api/rosters/[id]/unlock — POST (unlock — audited)
// =====================================================================
...
export async function POST(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (!existing.lockedAt) {
    return NextResponse.json({ error: "Roster is not locked." }, { status: 400 });
  }
  ...
  if (!body.reason) {
    return NextResponse.json({ error: "A reason is required to unlock a roster." }, { status: 400 });
  }
