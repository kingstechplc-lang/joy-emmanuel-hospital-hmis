...
//   GET  — list community outreach records
//   POST — create a new community outreach
// =====================================================================
...
export async function GET(req: Request) {
  ...
  if (search) {
    where.OR = [{ eventNumber: { contains: search, mode: "insensitive" } }, { title: { contains: search, mode: "insensitive" } }, { location: { contains: search, mode: "insensitive" } }, { teamLeadName: { contains: search, mode: "insensitive" } }];
  }
...
export async function POST(req: Request) {
  ...
  if (!eventType || !title || !location || !startDate) {
